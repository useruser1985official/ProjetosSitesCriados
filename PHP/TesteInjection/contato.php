...
<form method="post" name="contato" id="fContato" action="conclusao.php">
    <fieldset id="contato">
        ...
        <p><label for="cIdad">Idade: </label><input type="number" name="tIdad" id="cIdad" min="14" max="90" step="1" value="14"/></p>
    ...
    <input type="submit" value="Enviar a Mensagem" onclick="validar()"/>
