...
$TvrLang = array(
	...
	// Content-publish requires subscription
	'notify_content_publish' => esc_html__('Amender subscription', 'microthemer'),
	'notify_content_publish_long' => esc_html__('A subscription is required to publish Amender changes. Prices start from $29 per year', 'microthemer'),
	'purchase_amender' => esc_html__('Purchase Amender', 'microthemer'),
	...
	'mt_stylesheet' => esc_html__('(Microthemer Styles)', 'microthemer'),
	...
	'revision_restore_failed' => esc_html__('Revision restore failed', 'microthemer'),
	'revision_restore_failed_long' => esc_html__('The revision is no longer available. Older revisions are deleted to optimize space in the database.', 'microthemer'),
	...
	'popup_blocked_long' => esc_html__('tried to load the preview in a new window, as per your "Detach preview" setting in the VIEW menu. But your browser blocked this. Please use the option in your address bar to allow popups on this site, then refresh the page.', 'microthemer'),
	...
	'load_snippet' => esc_html__('Load snippet', 'microthemer'),
	'item' => esc_html__('item', 'microthemer'),
	'too_much_css' => esc_html__('The current page loads too much CSS to routinely analyse on this tab.', 'microthemer'),
	...
	'sample_css_confirm' => esc_html__("It may take several seconds to scan for CSS values (%d CSS rules detected). Your browser will be unresponsive during the scan, but the information collected may be useful. OK to proceed?"),
	...
	'trial_notice' => esc_html__('Please enter a Microthemer license key to unlock the full program! With the free trial you are limited to editing 15 Selectors. And not all style options are available e.g. masks, flexbox, grid, animation, transition, transform', 'microthemer'),
	...
	'settings_published_long' => esc_html__('Your Microthemer changes are live.', 'microthemer'),
	'settings_published_long_amender' => esc_html__('Your Amender changes are live.', 'microthemer'),
	...
	'messaging_ai' => esc_html__('Sending prompt', 'microthemer'),
	'messaging_ai_failed' => esc_html__('AI prompt failed', 'microthemer'),
	'more_context' => esc_html__('Supplying more context', 'microthemer'),
	'more_context_failed' => esc_html__('Supplying more context failed', 'microthemer'),
	...
	'page_reload_aborted' => esc_html__('Settings were saved. But you may need to reload the interface to see the effects', 'microthemer'),
	...
	'mt_targeting_disabled' => esc_html__('Targeting is OFF', 'microthemer'),
	'mt_targeting_enable' => esc_html__('targeting has been switched off to allow for the builder targeting controls. To turn this back on, use the "Targeting mode" switch at the bottom right of the interface. Alternatively, use the keyboard shortcut (Ctrl + Alt + T)', 'microthemer'),
	...
	'js_error_site' => esc_html__('discovered a JavaScript error on your site', 'microthemer'),
	'something_wrong_discovered' => esc_html__('The following errors were detected:', 'microthemer'),
	'something_wrong_no_errors' => esc_html__('hasn\'t discovered any yet though.', 'microthemer'),
	...
	'something_wrong_reliable' => esc_html__('for the most reliable/detailed debug info.',
		'microthemer'),
	'something_wrong_disable' => esc_html__('If the JavaScript error URL hints at a particular plugin, disable it. If the problem goes away, you know the source.', 'microthemer'),
	...
	'update_jquery_long' => esc_html__('Your WordPress install is running a version of jQuery older than 1.9. This means it is not possible to retrieve the existing computed CSS values elements on your web page. Please update to the latest version of WordPress (which should also update jQuery). If this doesn\'t help please check your code for any functions that deregister the default version of jQuery. You can ask Themeover to help you with this. Thanks.', 'microthemer'),
	...
	'navigate_mt' => esc_html__('You are already in', 'microthemer'),
	...
	'download_failed' => esc_html__('was not able to download the design pack', 'microthemer'),
	'delete_pack_confirm' => esc_html__('Are you sure you want to delete this design pack?', 'microthemer'),
	'delete_pack_failed' => esc_html__('was not able to delete the design pack', 'microthemer'),
