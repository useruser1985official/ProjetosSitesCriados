...
if ( ! function_exists( 'auto_post_exp_cal_datetime' ) ) {
	...
	function auto_post_exp_cal_datetime( $post_id ) {
		// Get the WordPress timezone string or offset.
...
function auto_post_exp_create_expiration_meta_box_callback( $post ) {
	...
	echo '<input type="text" name="expire_date" id="expire_date" class="date-vc" size="35" value="' . esc_attr( $passed_date ) . '"
	readonly>';
}
