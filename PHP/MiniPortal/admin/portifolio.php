       ...
       <section class="centro">
            ...
            <div class="tabela">
                <div class="linha">
                    ...
                    <div class="coluna">Resumo</div>
                    <div class="coluna">Conteúdo</div>
                ...
                <div class="linha">
                    ...
                    <div class="coluna"><?php echo $consulta[$i]["titulo"] ?></div>
                    <div class="coluna"><?php echo $consulta[$i]["url"] ?></div>
                    <div class="coluna"><?php echo $consulta[$i]["resumo"] ?></div>
                    <div class="coluna"><?php echo $consulta[$i]["conteudo"] ?></div>
                    <div class="coluna"><?php echo $consulta[$i]["data"] ?></div>
                    <div class="coluna"><?php echo $consulta[$i]["img_destaque"] ?></div>
                    <div class="coluna">
